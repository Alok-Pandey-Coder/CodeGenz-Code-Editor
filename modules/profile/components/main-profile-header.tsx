    ...
    <div className="flex items-center justify-between w-full min-h-[30vh] border-b border-neutral-800 bg-neutral-950 px-8 py-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-neutral-400">{userProfile.designation || "No designation yet"}</p>
      ...
      <div className="flex items-center gap-2">
        <button className="flex items-center gap-2 rounded-md border border-neutral-700 bg-neutral-900 px-4 py-2 text-sm text-neutral-200 hover:bg-neutral-800 transition">
